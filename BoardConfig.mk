...
# Kernel
TARGET_PREBUILT_KERNEL := device/samsung/note2/kernAl
#TARGET_KERNEL_SOURCE := kernel/samsung/smdk4412
#TARGET_KERNEL_CONFIG := custom_n7100_defconfig

BOARD_CUSTOM_BOOTIMG_MK := device/samsung/note2/custombootimg.mk
...
MR_INIT_DEVICES := device/samsung/note2/multirom/mr_init_devices.c
MR_DPI := hdpi
MR_DPI_FONT := 216
MR_FSTAB := device/samsung/note2/multirom/twrp.fstab
MR_KEXEC_MEM_MIN := 0x40000000
MR_USE_MROM_FSTAB := true
MR_INFOS := device/samsung/note2/mrom_infos
MR_DEVICE_HOOKS := device/samsung/note2/multirom/mr_hooks.c
